...
- `helmet.contentSecurityPolicy`:
  ...
  - Removed conditional support. This includes directive functions and support for a function as the `reportOnly`. [Read this if you need help.](https://helmetjs.github.io/faq/conditional-skip/)
...
- `helmet.hsts`:
  ...
  - Dropped support for `setIf`. [Read this if you need help.](https://helmetjs.github.io/faq/conditional-skip/) See [#232](https://github.com/helmetjs/helmet/issues/232)
